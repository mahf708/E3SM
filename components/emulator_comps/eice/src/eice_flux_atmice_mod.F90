...
!===============================================================================
  ...
  subroutine eice_flux_atmice(             &
    ...
    !--- formats ----------------------------------------
    character(*),parameter ::    F01 = "('(eice_flux_atmIce) ',a, i7,2x,d21.14)"
    character(*),parameter :: subName =  "(eice_flux_atmIce) "
    !-------------------------------------------------------------------------------
  ...
  end subroutine eice_flux_atmIce

end module eice_flux_atmice_mod
