...
NERSC Allocation Project: `eamxx_tutorial`
...
Be sure to update the following variables in the script to take advantage of the special allocation:
...
```shell
salloc --nodes 1 --qos interactive --time 01:00:00 --constraint gpu --gpus 4 --account e3sm --reservation eamxx_tutorial
