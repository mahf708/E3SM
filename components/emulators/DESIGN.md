...
| Samudra was trained on cell means over open water and ice; unweighting extends the open-water flux over the ice, and under full ice hands over zeros (Arctic FLUS 64, FLDS 42 W/m² against E3SMv3's 195 and 151; Antarctic net SW 252 against 121) | `ocn::cell_mean_forcing_sample` with the ice's surface from the exchange (`ice_surface_from`) | 3/4-ice, full-ice and open cells by hand; coupled ocean + energy-balance ice through MCT buffers |
