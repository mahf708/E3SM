 ...
 *
 * Step 5 uses the raw prediction, not what the coupler was shown: the blended
 * export lags the state by a fraction of a step, and feeding it back was a
 * defect in the Fortran atmosphere.
 */
