...
TEST_CASE("The Gaussian grid ACE and Samudra run on", "[scrip][real]") {
  // Both Fortran emulators read this file.  It is a Gaussian grid, so an
  // analytic regular 1-degree grid would not match it to the tolerance the
  // coupler checks atmosphere grids with.
  ...
  // row sits near -89.24, the latitude the atmosphere skeleton reported as 0.
